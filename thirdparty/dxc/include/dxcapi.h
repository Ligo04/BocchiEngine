...
typedef HRESULT(__stdcall* DxcCreateInstanceProc)(_In_ REFCLSID rclsid, _In_ REFIID riid,
                                                  _Out_ LPVOID* ppv);

typedef HRESULT(__stdcall* DxcCreateInstance2Proc)(_In_ IMalloc* pMalloc, _In_ REFCLSID rclsid,
...
extern "C" DXC_API_IMPORT HRESULT __stdcall DxcCreateInstance(_In_ REFCLSID rclsid,
                                                              _In_ REFIID riid, _Out_ LPVOID* ppv);
...
// This flag indicates that the shader hash was computed taking into account source information
// (-Zss)
...
struct IDxcLibrary : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE CreateBlobFromBlob(_In_ IDxcBlob* pBlob, UINT32 offset,
                                                         UINT32                  length,
    ...
    virtual HRESULT STDMETHODCALLTYPE
    CreateStreamFromBlobReadOnly(_In_ IDxcBlob* pBlob, _COM_Outptr_ IStream** ppStream) = 0;
    virtual HRESULT STDMETHODCALLTYPE
    GetBlobAsUtf8(_In_ IDxcBlob* pBlob, _COM_Outptr_ IDxcBlobEncoding** pBlobEncoding) = 0;
    virtual HRESULT STDMETHODCALLTYPE
    GetBlobAsUtf16(_In_ IDxcBlob* pBlob, _COM_Outptr_ IDxcBlobEncoding** pBlobEncoding) = 0;
};
...
struct IDxcCompiler : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE Compile(
        ...
        _In_opt_z_ LPCWSTR
            pSourceName,   // Optional file name for pSource. Used in errors and include handlers.
...
struct IDxcUtils : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE
    CreateBlobFromPinned(_In_bytecount_(size) LPCVOID pData, UINT32 size, UINT32 codePage,
                         _COM_Outptr_ IDxcBlobEncoding** pBlobEncoding) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE CreateBlob(_In_bytecount_(size) LPCVOID pData, UINT32 size,
                                                 UINT32                          codePage,
                                                 _COM_Outptr_ IDxcBlobEncoding** pBlobEncoding) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE
    CreateReadOnlyStreamFromBlob(_In_ IDxcBlob* pBlob, _COM_Outptr_ IStream** ppStream) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE
    GetBlobAsUtf16(_In_ IDxcBlob* pBlob, _COM_Outptr_ IDxcBlobUtf16** pBlobEncoding) = 0;

    virtual HRESULT STDMETHODCALLTYPE GetDxilContainerPart(
        _In_ const DxcBuffer* pShader, _In_ UINT32 DxcPart,
        _Outptr_result_nullonfailure_ void** ppPartData, _Out_ UINT32* pPartSizeInBytes) = 0;
...
typedef enum DXC_OUT_KIND
{
    ...
    DXC_OUT_SHADER_HASH =
        4,   // IDxcBlob - DxcShaderHash of shader or shader with source info (-Zsb/-Zss)
...
struct IDxcExtraOutputs : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE GetOutput(
        _In_ UINT32 uIndex, _In_ REFIID iid, _COM_Outptr_opt_result_maybenull_ void** ppvObject,
...
struct IDxcValidator2 : public IDxcValidator
{
    ...
    virtual HRESULT STDMETHODCALLTYPE ValidateWithDebug(
        ...
        _In_ UINT32    Flags,     // Validation flags.
        _In_opt_ DxcBuffer*
            pOptDebugBitcode,   // Optional debug module bitcode to provide line numbers
        _COM_Outptr_ IDxcOperationResult**
            ppResult   // Validation output status, buffer, and errors
        ) = 0;
};
...
struct IDxcContainerBuilder : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE
    AddPart(_In_ UINT32 fourCC, _In_ IDxcBlob* pSource) = 0;   // Part to add to the container
    virtual HRESULT STDMETHODCALLTYPE
    ...
    virtual HRESULT STDMETHODCALLTYPE SerializeContainer(
        _Out_ IDxcOperationResult**
            ppResult) = 0;   // Builds a container of the given container builder state
};
...
struct IDxcContainerReflection : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE GetPartContent(UINT32                  idx,
                                                     _COM_Outptr_ IDxcBlob** ppResult)      = 0;
...
struct IDxcOptimizerPass : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE GetOptionArgName(UINT32               argIndex,
                                                       _COM_Outptr_ LPWSTR* ppResult)        = 0;
    virtual HRESULT STDMETHODCALLTYPE GetOptionArgDescription(UINT32               argIndex,
                                                              _COM_Outptr_ LPWSTR* ppResult) = 0;
};
...
struct IDxcOptimizer : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE
    RunOptimizer(IDxcBlob* pBlob, _In_count_(optionCount) LPCWSTR* ppOptions, UINT32 optionCount,
...
struct IDxcVersionInfo2 : public IDxcVersionInfo
{
    virtual HRESULT STDMETHODCALLTYPE GetCommitInfo(
        ...
        _Outptr_result_z_ char**
            pCommitHash   // The SHA of the latest commit. (Must be CoTaskMemFree()'d!)
        ) = 0;
};
...
struct IDxcVersionInfo3 : public IUnknown
{
    virtual HRESULT STDMETHODCALLTYPE GetCustomVersionString(
        _Outptr_result_z_ char**
            pVersionString   // Custom version string for compiler. (Must be CoTaskMemFree()'d!)
        ) = 0;
};
...
struct IDxcPdbUtils : public IUnknown
{
    ...
    virtual HRESULT STDMETHODCALLTYPE GetSource(_In_ UINT32                     uIndex,
                                                _COM_Outptr_ IDxcBlobEncoding** ppResult) = 0;
    virtual HRESULT STDMETHODCALLTYPE GetSourceName(_In_ UINT32             uIndex,
                                                    _Outptr_result_z_ BSTR* pResult)      = 0;

    virtual HRESULT STDMETHODCALLTYPE GetFlagCount(_Out_ UINT32* pCount)       = 0;
    virtual HRESULT STDMETHODCALLTYPE GetFlag(_In_ UINT32             uIndex,
                                              _Outptr_result_z_ BSTR* pResult) = 0;
    ...
    virtual HRESULT STDMETHODCALLTYPE GetDefine(_In_ UINT32             uIndex,
                                                _Outptr_result_z_ BSTR* pResult) = 0;
...
CLSID_SCOPE const GUID CLSID_DxcLinker = {
    0xef6a8087, 0xb0ea, 0x4d56, {0x9e, 0x45, 0xd0, 0x7e, 0x1a, 0x8b, 0x78, 0x6}};
