...
#define RHI_FALSE false
    ...
    enum RHIStructureType : int
    {
        ...
        RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_PER_VIEW_ATTRIBUTES_PROPERTIES_NVX =
            1000097000,
        ...
        RHI_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_REQUIRED_SUBGROUP_SIZE_CREATE_INFO_EXT =
            1000225001,
        ...
        RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEDICATED_ALLOCATION_IMAGE_ALIASING_FEATURES_NV =
            1000240000,
        ...
        RHI_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_PROVOKING_VERTEX_STATE_CREATE_INFO_EXT =
            1000254001,
        ...
        RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DEMOTE_TO_HELPER_INVOCATION_FEATURES_EXT =
            1000276000,
        ...
        RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_CREATION_CACHE_CONTROL_FEATURES_EXT =
            1000297000,
        ...
        RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_UNIFORM_CONTROL_FLOW_FEATURES_KHR =
            1000323000,
        RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_ZERO_INITIALIZE_WORKGROUP_MEMORY_FEATURES_KHR =
            1000325000,
        ...
        RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRIMITIVE_TOPOLOGY_LIST_RESTART_FEATURES_EXT =
            1000356000,
        ...
        RHI_STRUCTURE_TYPE_DEBUG_REPORT_CREATE_INFO_EXT =
            RHI_STRUCTURE_TYPE_DEBUG_REPORT_CALLBACK_CREATE_INFO_EXT,
        RHI_STRUCTURE_TYPE_ATTACHMENT_SAMPLE_COUNT_INFO_NV =
            RHI_STRUCTURE_TYPE_ATTACHMENT_SAMPLE_COUNT_INFO_AMD,
        RHI_STRUCTURE_TYPE_RENDER_PASS_MULTIVIEW_CREATE_INFO_KHR =
            RHI_STRUCTURE_TYPE_RENDER_PASS_MULTIVIEW_CREATE_INFO,
        ...
        RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2_KHR =
            RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2,
        ...
        RHI_STRUCTURE_TYPE_IMAGE_FORMAT_PROPERTIES_2_KHR =
            RHI_STRUCTURE_TYPE_IMAGE_FORMAT_PROPERTIES_2,
        RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_FORMAT_INFO_2_KHR =
            RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_FORMAT_INFO_2,
        RHI_STRUCTURE_TYPE_QUEUE_FAMILY_PROPERTIES_2_KHR =
            RHI_STRUCTURE_TYPE_QUEUE_FAMILY_PROPERTIES_2,
        RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_PROPERTIES_2_KHR =
            RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_PROPERTIES_2,
        RHI_STRUCTURE_TYPE_SPARSE_IMAGE_FORMAT_PROPERTIES_2_KHR =
            RHI_STRUCTURE_TYPE_SPARSE_IMAGE_FORMAT_PROPERTIES_2,
        ...
        RHI_STRUCTURE_TYPE_MEMORY_ALLOCATE_FLAGS_INFO_KHR =
            RHI_STRUCTURE_TYPE_MEMORY_ALLOCATE_FLAGS_INFO,
        ...
        RHI_STRUCTURE_TYPE_DEVICE_GROUP_SUBMIT_INFO_KHR =
            RHI_STRUCTURE_TYPE_DEVICE_GROUP_SUBMIT_INFO,
        RHI_STRUCTURE_TYPE_DEVICE_GROUP_BIND_SPARSE_INFO_KHR =
            RHI_STRUCTURE_TYPE_DEVICE_GROUP_BIND_SPARSE_INFO,
        ...
        RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_GROUP_PROPERTIES_KHR =
            RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_GROUP_PROPERTIES,
        RHI_STRUCTURE_TYPE_DEVICE_GROUP_DEVICE_CREATE_INFO_KHR =
            RHI_STRUCTURE_TYPE_DEVICE_GROUP_DEVICE_CREATE_INFO,
        ...
        RHI_STRUCTURE_TYPE_EXTERNAL_IMAGE_FORMAT_PROPERTIES_KHR =
        ...
        RHI_STRUCTURE_TYPE_EXTERNAL_BUFFER_PROPERTIES_KHR =
            RHI_STRUCTURE_TYPE_EXTERNAL_BUFFER_PROPERTIES,
        RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_ID_PROPERTIES_KHR =
            RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_ID_PROPERTIES,
        RHI_STRUCTURE_TYPE_EXTERNAL_MEMORY_BUFFER_CREATE_INFO_KHR =
            RHI_STRUCTURE_TYPE_EXTERNAL_MEMORY_BUFFER_CREATE_INFO,
        RHI_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO_KHR =
            RHI_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO,
        RHI_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO_KHR =
            RHI_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO,
        RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SEMAPHORE_INFO_KHR =
            RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SEMAPHORE_INFO,
        RHI_STRUCTURE_TYPE_EXTERNAL_SEMAPHORE_PROPERTIES_KHR =
        ...
        RHI_STRUCTURE_TYPE_SURFACE_CAPABILITIES2_EXT =
            RHI_STRUCTURE_TYPE_SURFACE_CAPABILITIES_2_EXT,
        ...
        RHI_STRUCTURE_TYPE_FRAMEBUFFER_ATTACHMENT_IMAGE_INFO_KHR =
            RHI_STRUCTURE_TYPE_FRAMEBUFFER_ATTACHMENT_IMAGE_INFO,
        RHI_STRUCTURE_TYPE_RENDER_PASS_ATTACHMENT_BEGIN_INFO_KHR =
            RHI_STRUCTURE_TYPE_RENDER_PASS_ATTACHMENT_BEGIN_INFO,
        RHI_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_2_KHR =
            RHI_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_2,
        ...
        RHI_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO_2_KHR =
            RHI_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO_2,
        ...
        RHI_STRUCTURE_TYPE_EXTERNAL_FENCE_PROPERTIES_KHR =
            RHI_STRUCTURE_TYPE_EXTERNAL_FENCE_PROPERTIES,
        RHI_STRUCTURE_TYPE_EXPORT_FENCE_CREATE_INFO_KHR =
            RHI_STRUCTURE_TYPE_EXPORT_FENCE_CREATE_INFO,
        ...
        RHI_STRUCTURE_TYPE_IMAGE_VIEW_USAGE_CREATE_INFO_KHR =
            RHI_STRUCTURE_TYPE_IMAGE_VIEW_USAGE_CREATE_INFO,
        ...
        RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTER_FEATURES_KHR =
            RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTERS_FEATURES_KHR,
        RHI_STRUCTURE_TYPE_MEMORY_DEDICATED_REQUIREMENTS_KHR =
            RHI_STRUCTURE_TYPE_MEMORY_DEDICATED_REQUIREMENTS,
        RHI_STRUCTURE_TYPE_MEMORY_DEDICATED_ALLOCATE_INFO_KHR =
            RHI_STRUCTURE_TYPE_MEMORY_DEDICATED_ALLOCATE_INFO,
        ...
        RHI_STRUCTURE_TYPE_BUFFER_MEMORY_REQUIREMENTS_INFO_2_KHR =
            RHI_STRUCTURE_TYPE_BUFFER_MEMORY_REQUIREMENTS_INFO_2,
        RHI_STRUCTURE_TYPE_IMAGE_MEMORY_REQUIREMENTS_INFO_2_KHR =
        ...
        RHI_STRUCTURE_TYPE_IMAGE_FORMAT_LIST_CREATE_INFO_KHR =
            RHI_STRUCTURE_TYPE_IMAGE_FORMAT_LIST_CREATE_INFO,
        RHI_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_CREATE_INFO_KHR =
            RHI_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_CREATE_INFO,
        RHI_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_INFO_KHR =
            RHI_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_INFO,
        RHI_STRUCTURE_TYPE_BIND_IMAGE_PLANE_MEMORY_INFO_KHR =
            RHI_STRUCTURE_TYPE_BIND_IMAGE_PLANE_MEMORY_INFO,
        ...
        RHI_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_SUPPORT_KHR =
            RHI_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_SUPPORT,
        ...
        RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_DRIVER_PROPERTIES_KHR =
            RHI_STRUCTURE_TYPE_PHYSICAL_DEVICE_DRIVER_PROPERTIES,
        ...
        RHI_STRUCTURE_TYPE_SEMAPHORE_TYPE_CREATE_INFO_KHR =
            RHI_STRUCTURE_TYPE_SEMAPHORE_TYPE_CREATE_INFO,
        RHI_STRUCTURE_TYPE_TIMELINE_SEMAPHORE_SUBMIT_INFO_KHR =
            RHI_STRUCTURE_TYPE_TIMELINE_SEMAPHORE_SUBMIT_INFO,
        ...
        RHI_STRUCTURE_TYPE_IMAGE_STENCIL_USAGE_CREATE_INFO_EXT =
            RHI_STRUCTURE_TYPE_IMAGE_STENCIL_USAGE_CREATE_INFO,
        ...
        RHI_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_INFO_KHR =
            RHI_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_INFO,
    ...
    enum RHIFormat : int
    {
        ...
        RHI_FORMAT_R10X6G10X6B10X6A10X6_UNORM_4PACK16_KHR =
            RHI_FORMAT_R10X6G10X6B10X6A10X6_UNORM_4PACK16,
        RHI_FORMAT_G10X6B10X6G10X6R10X6_422_UNORM_4PACK16_KHR =
            RHI_FORMAT_G10X6B10X6G10X6R10X6_422_UNORM_4PACK16,
        RHI_FORMAT_B10X6G10X6R10X6G10X6_422_UNORM_4PACK16_KHR =
            RHI_FORMAT_B10X6G10X6R10X6G10X6_422_UNORM_4PACK16,
        RHI_FORMAT_G10X6_B10X6_R10X6_3PLANE_420_UNORM_3PACK16_KHR =
            RHI_FORMAT_G10X6_B10X6_R10X6_3PLANE_420_UNORM_3PACK16,
        RHI_FORMAT_G10X6_B10X6R10X6_2PLANE_420_UNORM_3PACK16_KHR =
            RHI_FORMAT_G10X6_B10X6R10X6_2PLANE_420_UNORM_3PACK16,
        RHI_FORMAT_G10X6_B10X6_R10X6_3PLANE_422_UNORM_3PACK16_KHR =
            RHI_FORMAT_G10X6_B10X6_R10X6_3PLANE_422_UNORM_3PACK16,
        RHI_FORMAT_G10X6_B10X6R10X6_2PLANE_422_UNORM_3PACK16_KHR =
            RHI_FORMAT_G10X6_B10X6R10X6_2PLANE_422_UNORM_3PACK16,
        ...
        RHI_FORMAT_R12X4G12X4B12X4A12X4_UNORM_4PACK16_KHR =
            RHI_FORMAT_R12X4G12X4B12X4A12X4_UNORM_4PACK16,
        RHI_FORMAT_G12X4B12X4G12X4R12X4_422_UNORM_4PACK16_KHR =
            RHI_FORMAT_G12X4B12X4G12X4R12X4_422_UNORM_4PACK16,
        RHI_FORMAT_B12X4G12X4R12X4G12X4_422_UNORM_4PACK16_KHR =
            RHI_FORMAT_B12X4G12X4R12X4G12X4_422_UNORM_4PACK16,
        RHI_FORMAT_G12X4_B12X4_R12X4_3PLANE_420_UNORM_3PACK16_KHR =
            RHI_FORMAT_G12X4_B12X4_R12X4_3PLANE_420_UNORM_3PACK16,
        RHI_FORMAT_G12X4_B12X4R12X4_2PLANE_420_UNORM_3PACK16_KHR =
            RHI_FORMAT_G12X4_B12X4R12X4_2PLANE_420_UNORM_3PACK16,
        ...
        RHI_FORMAT_G12X4_B12X4R12X4_2PLANE_422_UNORM_3PACK16_KHR =
            RHI_FORMAT_G12X4_B12X4R12X4_2PLANE_422_UNORM_3PACK16,
    ...
    enum RHISamplerAddressMode : int
    {
        ...
        RHI_SAMPLER_ADDRESS_MODE_MIRROR_CLAMP_TO_EDGE_KHR =
    ...
    enum RHIImageUsageFlagBits
    {
        ...
        RHI_IMAGE_USAGE_SHADING_RATE_IMAGE_BIT_NV =
